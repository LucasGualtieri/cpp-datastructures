#ifndef ADJACENCY_TREE_HPP
#define ADJACENCY_TREE_HPP
...
class AdjacencyTree : public DataStructure {
private:

    LinearList<AVL<Pair<Vertex, float>>> adjList;
    bool isWeighted, isDirected;

public:

    ~AdjacencyTree() override {}
	AdjacencyTree() : isWeighted(false), isDirected(false) {}
